...
public final class ModBlock
{
    ...
    public static final SteamNSteelStructureBlock shearer = new ShearerStructure();
    public static final SteamNSteelStructureBlock playerPiano = new PlayerPiano();
    public static final SteamNSteelStructureBlock theMechanicalTurk = new TurkStructure();
    public static final SteamNSteelStructureBlock danseMacabre = new DanseMacabreStructure();
    ...
    public static void registerTileEntities()
    {
        ...
        GameRegistry.registerTileEntity(ShearerTE.class, getTEName(ShearerStructure.NAME));
        GameRegistry.registerTileEntity(PlayerPianoTE.class, getTEName(PlayerPiano.NAME));
        GameRegistry.registerTileEntity(DanseMacabreTE.class, getTEName(DanseMacabreStructure.NAME));
        GameRegistry.registerTileEntity(TurkTE.class, getTEName(TurkStructure.NAME));
    ...
    public static void init()
    {
        ...
        registerStructures(shearer, ShearerStructure.NAME);
        registerStructures(playerPiano,PlayerPiano.NAME);
        registerStructures(theMechanicalTurk, TurkStructure.NAME);
        registerStructures(danseMacabre, DanseMacabreStructure.NAME);
